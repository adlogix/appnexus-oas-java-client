...
@AllArgsConstructor
public abstract class CampaignParameterMapTransformer extends AbstractParameterMapTransformer {

	protected static final DateTimeFormatter startTimeFormatter = DateTimeFormat.forPattern("HH:00");
	protected static final DateTimeFormatter endTimeFormatter = DateTimeFormat.forPattern("HH:59");
	...
	protected abstract Map<String, Object> getPageParameters(Campaign campaign);

	protected abstract Map<String, Object> getExcludeParameters(Campaign campaign);

	protected abstract Map<String, Object> getOverviewParameters(Campaign campaign);

	protected Map<String, Object> getCommonOverviewParameters(Campaign campaign) {
	...
	protected abstract Map<String, Object> getScheduleParameters(Campaign campaign);

	protected Map<String, Object> getCommonScheduleParameters(Campaign campaign) {
	...
	protected Map<String, Object> getTargetingParameters(Campaign campaign) {
		final Map<String, Object> parameters = new HashMap<String, Object>();
	...
	protected Map<String, Object> getTargetingZoneParameters(Campaign campaign) {
		final Map<String, Object> parameters = new HashMap<String, Object>();
		addTargetingToParameters(TargetingCode.ZONE, campaign.getZoneTargeting(), parameters);
		return parameters;
	}

	protected Map<String, Object> getTargetingGeneralParameters(Campaign campaign) {
		final Map<String, Object> parameters = new HashMap<String, Object>();
	...
	protected Map<String, Object> getMobileTargetingParameters(Campaign campaign) {
		final Map<String, Object> parameters = new HashMap<String, Object>();
	...
	protected void addTargetingsToParameters(final Map<TargetingCode, ? extends CampaignTargetValues> targetings,
	...
	protected void addTargetingToParameters(TargetingCode code, CampaignTargetValues targetingValues,
			final Map<String, Object> parameters) {
	...
	protected Map<String, Object> getRdbTargetingParameters(Campaign campaign) {
		final Map<String, Object> parameters = new HashMap<String, Object>();
	...
	protected Map<String, Object> getSegmentTargetingParameters(Campaign campaign) {

		final Map<String, Object> parameters = new HashMap<String, Object>();

		SegmentTargeting segmentTargeting = campaign.getSegmentTargeting();
		if (isSegmentTargetingEmpty(segmentTargeting)) {
	...
	protected abstract boolean isSegmentTargetingEmpty(SegmentTargeting segmentTargeting);

	protected abstract Map<String, Object> getBillingParameters(Campaign campaign);

	protected Map<String, Object> getCommonBillingParameters(Campaign campaign) {
		final Map<String, Object> parameters = new HashMap<String, Object>();
	...
	protected abstract boolean injectNotNullFlagParams();
}
